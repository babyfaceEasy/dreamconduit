...
<!-- Portfolio Grid Section -->
    <section id="portfolio">
        ...
        <div class="col-md-4" style="margin-bottom: 10px; ">
            <div id="far" align="center" style="height: 50px; padding: 10px;font-size: 17px; background-color: #0000ff; color: #fff;">
            <span id="clock"></span>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <button type="button" onclick="if(confirm('Are you sure you want to submit?')) {document.getElementById('test_form').submit();}" class="btn btn-success btn-block">I'm Done, Submit Test</button>
                    <p class="text-center">
