                ...
                <div class="panel-body">
                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/candidate/password/email') }}">
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4 col-lg-6-offset-4">
                                <button type="submit" class="btn btn-primary">
                                    Send Password Reset Link
                                </button>
                                <div class="clearfix"></div>
                                                    <button class="btn btn-default pull-right" style="margin-top: 15px; background-color:#423562; color: #fff;"><a href="#" style="color: #fff">Back</a></button>
